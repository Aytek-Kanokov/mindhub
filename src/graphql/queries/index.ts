...
import {
  ...
  getLessonByIdQuery,
  getInstructorAccountQuery,
  getLessonsInCourseQuery,
  getCourseByIdQuery,
  getInstructorCollectionQuery,
} from '../gql';
...
export const getInstructorByEmail = (instructor_email: string) => {
  return apolloClient.query({
    query: getInstructorAccountQuery,
    variables: {
